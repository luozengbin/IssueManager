...
public class ConfigFacade {
	...
	private static final ConfigFacade instance = new ConfigFacade(System.getProperty(Constants.CONFIG_FILE));

	protected Config config = null;

	private ConfigFacade(String configFile) {
		try {
			config = JSON.decode(FileUtils.readFileAsString(configFile), Config.class);
		} catch (Exception e) {
